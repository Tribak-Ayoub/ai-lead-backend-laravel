      ...
      <tbody class="bg-white divide-y divide-gray-200">
        ...
        <template v-if="loading">
          <tr
            v-for="n in 4"
            :key="n"
            class="md:table-row block border-b md:border-none mb-4 md:mb-0 rounded-lg md:rounded-none shadow-sm md:shadow-none bg-white md:bg-transparent"
          >
        ...
        <template v-else>
          <tr
            v-for="user in users"
            :key="user.id"
            class="mb-2 md:table-row block hover:bg-gray-50 transition rounded-lg md:rounded-none shadow-sm md:shadow-none bg-white md:bg-transparent"
          >
            <!-- User Info -->
            ...
            <td class="px-6 py-4 text-sm block md:table-cell">
              <div class="flex items-center space-x-2">
                <button @click="openModal(user)" title="View Details" class="p-2 rounded-md text-gray-400 hover:text-indigo-600 hover:bg-indigo-50">
                  <Eye class="w-4 h-4" />
                </button>
                <button @click="editUser(user)" title="Edit" class="p-2 rounded-md text-blue-600 hover:text-blue-800 hover:bg-blue-50">
                  <Edit class="w-4 h-4" />
                </button>
                <button @click="deleteUser(user)" title="Delete" class="p-2 rounded-md text-red-600 hover:text-red-800 hover:bg-red-50">
